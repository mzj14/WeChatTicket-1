...
class CustomWeChatView(WeChatView):
    ...
    #WECHAT_TOKEN = "chengjiaxin"
    #WECHAT_APPID = "wxc6d244e328240dbb"
    #WECHAT_SECRET = "9ae2d16cc76e9428e78a70f90002ff22"

    handlers = [
        HelpOrSubscribeHandler, UnbindOrUnsubscribeHandler, BindAccountHandler, BookEmptyHandler,Arithmetic
    ]
